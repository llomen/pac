...
进入饭团主页pvs1
    公共-校验数据    ${pvs1}    ft_xiangqing_01    ${table_pvs1}    1
...
饭团主页返回pvs1
    公共-校验数据    ${pvs1}    ft_xiangqing_02    ${table_pvs1}    1
...
进度控制页面pvs1
    公共-校验数据    ${pvs1}    ft_xiangqing_07    ${table_pvs1}    1
...
进度控制页面返回pvs1
    公共-校验数据    ${pvs1}    ft_xiangqing_08    ${table_pvs1}    1
...
视频动态详情页返回pvs1
    公共-校验数据    ${pvs1}    ft_xiangqing_06    ${table_pvs1}    1
