...
进入饭团show-banner
    sleep    5
    公共-校验数据    {'logtype':'show','lob':'smod=5'}    show_square_01    ${table_show}    1

进入饭团show-热门话题
    sleep    5
    公共-校验数据    {'logtype':'show','lob':'smod=7'}    show_square_02    ${table_show}    1

进入饭团show-人气榜
    sleep    5
    公共-校验数据    {'logtype':'show','lob':'smod=23'}    show_square_03    ${table_show}    1

进入饭团show-最佳饭贴
    sleep    5
    公共-校验数据    {'logtype':'show','lob':'smod=70'}    show_square_04    ${table_show}    1
...
热门话题详情页show
    公共-校验数据    ${show}    show_square_07    ${table_show}    1
...
参与开通饭团show
    ...
    公共-校验数据    ${show}    show_square_05    ${table_show}    1
