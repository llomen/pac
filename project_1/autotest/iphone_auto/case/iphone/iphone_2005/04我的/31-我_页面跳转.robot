...
消息中心-登录pvs1
    公共-校验数据    ${pvs1}    xiaoxizhongxin_login    ${table_pvs1}    1
...
登录-消息中心pvs1
    公共-校验数据    ${pvs1}    xiaoxizhongxin_login_back    ${table_pvs1}    1
...
账号与安全pvs1
    公共-校验数据    ${pvs1}    shezhi_012    ${table_pvs1}    1
...
账号与安全返回pvs1
    公共-校验数据    ${pvs1}    shezhi_013    ${table_pvs1}    1
