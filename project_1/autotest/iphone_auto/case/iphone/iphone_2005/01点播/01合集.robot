...
点播前贴广告结束ae
    公共-校验数据    ${ae}    dianbo_002    mpp_kpi_iphone    1

广告播放中上报type0
    公共-校验数据    {'type':'0'}    bofangzhong_type0    ${table_adcdn}    1

广告播放中上报type1
    公共-校验数据    {'type':'1'}    bofangzhong_type1    ${table_adcdn}    1

广告播放中上报type3
    公共-校验数据    {'type':'3'}    bofangzhong_type3    ${table_adcdn}    1

广告播放中上报type4
    公共-校验数据    {'type':'4'}    bofangzhong_type4    ${table_adcdn}    1

广告播放中上报type6
    公共-校验数据    {'type':'6'}    bofangzhong_type6    ${table_adcdn}    1
...
分享到QQshare
    ...
    公共-校验数据    ${share}    share_dianbo_05    ${table_click}    1

分享到QQ空间share
    点击确认按钮
    Comment    点播播放页-分享到    QQ空间
    点击确认按钮
    公共-校验数据    ${share}    share_dianbo_06    ${table_click}    1
