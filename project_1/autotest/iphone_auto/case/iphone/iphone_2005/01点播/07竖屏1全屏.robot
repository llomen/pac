...
开始下载oc
    ...
    公共-校验数据    ${oc_start}    oc_start    ${table_click}    2
...
竖屏全屏分享点击share
    公共-校验数据    {'act':'share','pos':'9'}    pfc-huancun-show2    ${table_click}    1

竖屏全屏分享弹出share
    公共-校验数据    {'act':'share','pos':'16'}    pfc-huancun-show2    ${table_click}    1

分享到微信share
    公共-删除数据
    公共－点击页面文本    微信
    公共－点击页面文本    确认
    公共-校验数据    {'act':'share'}    pfc-huancun-show2    ${table_click}    1
...
心跳停止hb
    sleep    2
    公共-校验数据    ${hb_end}    feed_03    ${table_hb_sdk}    1
