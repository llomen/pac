...
点播15hb
    sleep    3
    公共-校验数据    ${hb15}    shikan_15    ${table_hb_sdk}    1

点播45hb
    sleep    33
    公共-校验数据    ${hb45}    shikan_45    ${table_hb_sdk}    1

点播60hb
    sleep    20
    公共-校验数据    ${hb60}    shikan_60    ${table_hb_sdk}    1

点播180hb
    sleep    120
    公共-校验数据    ${hb180}    shikan_180    ${table_hb_sdk}    1
