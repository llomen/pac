...
*** Test Cases ***
首页精选频道-按钮展示
    公共-页面包含元素    name=${icon_download}
    公共-页面包含元素    name=${icon_fangsong}
    公共-页面包含元素    name=${icon_saoma}

首页精选频道-离线缓存
    公共－点击页面文本    ${icon_download}
    公共-页面包含元素    离线缓存
...
首页精选频道-播放记录
    ...
    公共-页面包含元素    每日放送
    非播放页-返回
    comment    公共－点击页面文本    ${icon_notice}
    comment    公共-页面包含元素    消息中心
    comment    非播放页-返回

频道切换-点击跳转综艺
    公共－点击页面文本    综艺
    公共-页面不包含元素    name=${icon_download}
    公共-页面不包含元素    name=${icon_fangsong}
...
跳转频道管理
    ...
    公共-页面包含元素    电视剧
    公共-页面包含元素    直播
    公共-页面包含元素    xpath=//XCUIElementTypeStaticText[@name="体育"]/preceding-sibling::XCUIElementTypeImage[1]
