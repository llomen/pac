*** Keywords ***
快速启动应用
    Open Application    ${appium_server}    platformName=iOS    deviceName=${deviceName}    platformVersion=${platformVersion}    newCommandTimeout=600    bundleId=com.hunantv.imgotv    udid=${udid}    AutomationName=XCUITest
...
启动应用2
    comment    Open Application    http://10.200.12.73:4735/wd/hub    platformName=iOS    deviceName=${deviceName}    platformVersion=12.4    newCommandTimeout=600    bundleId=com.hunantv.imgotv    udid=${udid}    AutomationName=XCUITest
    Open Application    ${appium_server}    platformName=iOS    deviceName=${deviceName}    platformVersion=${platformVersion}    newCommandTimeout=600    bundleId=com.hunantv.imgotv    udid=${udid}    AutomationName=XCUITest    autoAcceptAlerts=true
