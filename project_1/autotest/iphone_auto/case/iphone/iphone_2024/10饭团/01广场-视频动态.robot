...
广场动态曝光show
    ...
    首页-饭团
    sleep    3
    公共-校验数据    {'logtype':'show','smod':'1'}    show_square_06    ${table_show}    1
...
举报fantuan4
    ...
    公共－点击页面文本    举报
    公共－点击页面文本    其他
    公共-校验数据    ${fantuan}    fantuan_tuijian_14_4    ${table_click}    1
...
点赞跳登录pvs1
    公共-校验数据    ${pvs1}    ft_guangchang_35    ${table_pvs1}    0

点赞跳登录pvs1
    公共-校验数据    ${cv}    login_10    ${table_cv}    1
