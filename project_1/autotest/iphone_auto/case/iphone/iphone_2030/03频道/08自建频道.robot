...
节目tab页取消标签
    公共-删除数据
    公共－点击页面文本    芒果出品
    run keyword and ignore error    公共－点击页面文本    确定
    公共-校验数据    ${crech}    crech_08    ${table_click}    1
...
删除频道
    ${aa}    run keyword and return status    page should contain element    编辑我的频道
    run keyword if    ${aa}    删除我的频道

删除我的频道
    公共－点击页面文本    编辑我的频道
    点击全部元素    custom edit arrange
    公共－点击页面文本    删除
    公共－点击页面文本    完成
    公共－点击页面文本    确定关闭
    首页-频道管理
