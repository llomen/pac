...
进入H5pvs
    #进入时就会上报进入芒果文学和从芒果文学退出2个PV，已遗留
    公共-校验数据    {'act':'pvs','cpn':'56'}    shouye_01    ${table_pvs_other}    1

进入H5pvs1
    公共-校验数据    ${pvs1_H5}    shouye_01    ${table_pvs1}    1

H5返回精选pvs
    芒果文学返回
    公共-校验数据    {'act':'pvs','cpn':'1'}    shouye_02    ${table_pvs_other}    1

H5返回精选pvs1
    公共-校验数据    {'logtype':'pv','cntp':'ch_channel'}    shouye_02    ${table_pvs1}    1
