...
点我的看单视频my
    ...
    看单-点单视频
    sleep    3
    公共-校验数据    ${my}    my_bofang_play_list    ${table_click}    0

跳转点播页pvs
    公共-校验数据    ${pvs}    kandan_001    ${table_pvs_dianbo}    1

跳转点播页pvs1
    公共-校验数据    ${pvs1}    kandan_001    ${table_pvs1}    1
...
点播页返回我的pvs
    公共-删除数据
    点播播放页-返回
    公共-校验数据    ${pvs}    kandan_back_001    ${table_pvs}    1

点播页返回我的pvs1
    公共-校验数据    ${pvs1}    kandan_back_001    ${table_pvs1}    1
